...
const SolutionDetails = () => {
  const selectedSolution = solutionsData.find((item) => item?.id === 2);
  ...
  return (
    <div className="bg-fixed bg-cover bg-header-bg">
      ...
      <div className="grid grid-cols-2 h-[350px] bg-black/60">
        <div className="flex items-center justify-center text-mainColor font-bold text-[2.5rem] ltr:px-56 rtl:px-48 text-center">
