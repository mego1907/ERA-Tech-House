...
const SolutionDetails = () => {
  const selectedSolution = solutionsData.find((item) => item?.id === 1);
  ...
  return (
    <div className="bg-fixed bg-cover bg-header-bg">
      ...
      <div className="grid grid-cols-2 h-[350px] bg-black/60">
        ...
        <div className="flex items-center leading-relaxed justify-center text-base text-white max-w-[50ch] text-center">
      ...
      <div className="flex flex-col mx-16 mt-8 mb-2 bg-black/60">
        ...
        <div className="grid grid-cols-2">
          ...
          <div className="flex flex-col items-center justify-center text-base text-white p-28">
            <p className="leading-relaxed">{t(selectedSolution?.desc1)}</p>
            <p className="leading-relaxed ltr:pl-5 rtl:pr-5">
              {t(selectedSolution?.desc2)}
            </p>
          </div>
        </div>
      </div>
